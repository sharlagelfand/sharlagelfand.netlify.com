...
For the first post in my [Me, me, me, 2019]("me-me-me-2019") series, I figured I'd do something that is especially topical: tweets. Spoiler alert, but in January my tweeting was at an all time high, absolutely exacerbated by RStudio conf.
...
I'll start by reading in my tweets. I have ~3000 overall, so 2000 should be enough for what I'm trying to do.
...
I'm going to mess with the dates *one last time*, by changing the timezone to Central if the tweets were during RStudio conf. That hour difference from Toronto really matters, ok `r emo::ji("information_desk_person")`.
...
Ok, let's actually look at some tweets! `r emo::ji("bird")`
...
I really am not normally this popular, I promise. I know what my top-favourited tweet is and it is absolutely absurd.
...
Yep, checks out. Every single person on that list was at the conference!
...
(yes, top 10 to top 8, sorry Erin and JD -- I want a 3x3 plot in like just a sec and I need to include myself OK sorry!)
...
Every single one of these people likes and uses R. But would it really be a Twitter analysis if I didn't do some text analysis? I'm going to do tf-idf (using Julia Silge and drob's [`tidytext` package]()), 1) because [I have blogged about it before and can copy my old code](https://sharla.party/posts/horoscopes/), but mostly 2) because it's a fun way to look at differences in how people communicate.
...
[Caitlin](https://twitter.com/beeonaposy) loves Texas and data science. [Brooke](https://twitter.com/brookLYNevery1) had her epic [mug thread](https://twitter.com/brookLYNevery1/status/1083867336212393984), her [#rstudioconf drawings](https://twitter.com/brookLYNevery1/status/1085923987681624064), and of course her undercut. [Mara](https://twitter.com/dataandme) is a mix of #SEO badness and umms. 
