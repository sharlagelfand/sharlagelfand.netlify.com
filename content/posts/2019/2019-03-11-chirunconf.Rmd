...
There is also so much work left to be done, projects that need continued contributions, and issues that didn't get worked on at all. If you're interested in contributing to open source in R, I think the output and leftover issues from an unconf are a great place to look for inspiration. You can see all of the chirunconf19 issues [here](https://github.com/chirunconf/chiruncon19).
