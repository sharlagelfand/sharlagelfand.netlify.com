...
This example map is bare bones, but the idea is fleshed out a little more in a Shiny app, which you can find [here](https://sharlagelfand.shinyapps.io/toronto-sexual-health-clinics/). I added in a little more interactivity, namely that a clinic's drop-in hours, appointment hours, and additional services pop up when you click on it in the map. It also lists the services that all clinics offer. All the code is available [here](https://github.com/sharlagelfand/toronto-sexual-health-clinics) on my GitHub.
